...
- 最多保存 50 位朋友，通过“参加”开关选择本次约饭的人（至少两位）。关闭后保留地址、出行方式与权重；可按名字或地址搜索朋友。
- 选择地铁站、商圈或在地图上选点作为起点；可选开通深圳详细地址搜索。左侧使用紧凑卡片，未参加的人收起为摘要，仍可展开编辑资料。
...
- 朋友资料与参加状态保存在本机浏览器，刷新后保留；无需登录。旧版方案自动迁移，原有朋友默认参加。
